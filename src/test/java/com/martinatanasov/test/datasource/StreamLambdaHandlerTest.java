...
public class StreamLambdaHandlerTest {
    ...
    public void ping_streamRequest_respondsWithHello() {
        ...
        assertTrue(response.getBody().contains("abv@abv.bg"));
        assertTrue(response.getBody().contains("manager@abv.bg"));
        assertTrue(response.getBody().contains("admin@abv.bg"));
        assertTrue(response.getBody().contains("manager@gmail.com"));
        assertTrue(response.getBody().contains("admin@gmail.com"));
